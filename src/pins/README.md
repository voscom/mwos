# MWOSPins — Система управления портами
Предоставляет унифицированный интерфейс для управления GPIO пинами, поддержки прерываний и работы с внешними расширителями портов через различные интерфейсы (I2C, SPI и др.).
Модули MWOS используют этот интерфейс для управления портами, что позволяет использовать единую адресацию портов внутри MWOS. 
...
| Класс | Описание |
| :--- | :--- |
| [MWOSPinsMain.md](MWOSPinsMain.md) | Основной блок портов микроконтроллера (GPIO) |
| [MWOSPinsMCP23017.md](MWOSPinsMCP23017.md) | Расширитель на 16 цифровых портов через I2C (MCP23017) |
| [MWOSPinsMCP4725.md](MWOSPinsMCP4725.md) | Расширитель на 1 порт ЦАП через I2C (MCP4725) |
