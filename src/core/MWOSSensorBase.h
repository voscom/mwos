...
#pragma pack(pop)
    ...
    MWOS_PARAM(0, valueBin, mwos_param_bits1, mwos_param_readonly, mwos_param_storage_no, sensorsCount);
    ...
    virtual void onInit() {
        ...
        MW_LOG_MODULE(this); MW_LOG(F("onInited sensor ")); MW_LOG(_pull_off); MW_LOG('='); MW_LOG_LN(_always_off);
    }
